...
public class WSwithDatabaseTest extends AbstractTestWrapper {
	public static Logger logger = Logger.getLogger(WSwithDatabaseTest.class
			.getName());
	...
	public void testAddBookServiceFlow() throws Exception {
		...
		testBuilder.addAssertion(new XMLFileAssertion("a001WSPutMessage")
