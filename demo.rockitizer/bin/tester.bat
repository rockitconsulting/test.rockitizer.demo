...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="tester" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.junit.runner.JUnitCore %CMD_LINE_ARGS%
