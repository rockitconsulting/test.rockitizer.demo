...
set CLASSPATH="%BASEDIR%"\etc;"%REPO%"\test.rockitizer-1.0.5.3-20200610.122147-2.jar;"%REPO%"\ojdbc8_g-19.3.0.0.jar;"%REPO%"\ojdbc8dms-19.3.0.0.jar;"%REPO%"\ojdbc8dms_g-19.3.0.0.jar;"%REPO%"\dms-19.3.0.0.jar;"%REPO%"\db2jcc-db2jcc4.jar;"%REPO%"\com.ibm.mq.allclient-9.1.4.0.jar;"%REPO%"\bcprov-jdk15on-1.64.jar;"%REPO%"\bcpkix-jdk15on-1.64.jar;"%REPO%"\javax.jms-api-2.0.1.jar;"%REPO%"\snakeyaml-1.25.jar;"%REPO%"\junit-4.12.jar;"%REPO%"\hamcrest-core-1.3.jar;"%REPO%"\log4j-1.2.17.jar;"%REPO%"\httpclient-4.5.jar;"%REPO%"\httpcore-4.4.1.jar;"%REPO%"\commons-logging-1.2.jar;"%REPO%"\commons-codec-1.9.jar;"%REPO%"\xmlunit-core-2.1.0.jar;"%REPO%"\guava-27.0-jre.jar;"%REPO%"\failureaccess-1.0.jar;"%REPO%"\listenablefuture-9999.0-empty-to-avoid-conflict-with-guava.jar;"%REPO%"\jsr305-3.0.2.jar;"%REPO%"\checker-qual-2.5.2.jar;"%REPO%"\error_prone_annotations-2.2.0.jar;"%REPO%"\j2objc-annotations-1.1.jar;"%REPO%"\animal-sniffer-annotations-1.17.jar;"%REPO%"\jsch-0.1.54.jar;"%REPO%"\commons-io-2.4.jar;"%REPO%"\json-20160810.jar;"%REPO%"\commons-text-1.8.jar;"%REPO%"\commons-lang3-3.9.jar;"%REPO%"\picocli-4.2.0.jar;"%REPO%"\jansi-1.18.jar;"%REPO%"\demo.rockitizer-0.0.1-SNAPSHOT.jar
